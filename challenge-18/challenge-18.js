(function main() {
    ...
    */
    ...
    function cleanCPF( cpf ) {
        var regexCPF = /(\d+)\D+(\d+)\D+(\d+)\D+(\d+)/;
        function joinCPFParts( match, part1, part2, part3, part4 ) {
            return part1 + part2 + part3 + part4;
        };
        var CPFOnlyNumber = cpf.replace( regexCPF, joinCPFParts );
    ...
    CPFOnlyNumber.forEach(function( item ) {
        console.log( item );
    });
    ...
    */
    ...
    CPFOnlyNumber.forEach( function( cpf ) {
    ...
    */
    ...
    console.log( 'Os meses de janeiro, junho e julho começam com a letra j.'.match(/j[a-z]{3}o/g) );
