...
(function main() {
    ...
    */
    var subtracion = calculator( 4, 3 );
    var multiplication = calculator( 7, 0.5 );
    var division = calculator( 3, 1 );
    var mod = calculator( 1, 3 );
    ...
    */
    ...
    console.log( subtracion( function ( x, y ) { return x - y; } ) );
