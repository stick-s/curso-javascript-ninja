(function main(){
    ...
    */
    ...
    console.log( text.replace( '/Manuel Marques de Sousa/', 'stick' ) );
    ...
    */
    ...
    console.log( text.replace( '/brasileiro/g', 'sticklandia' ) );
    ...
    */
    ...
    console.log( text.replace( /[Aa]/gi, '4' ) );
    ...
    */
    ...
    function replaceDate( date ) {
        ...
        var month = getMonthNumber( date.slice( 6, 11 ) );
        var year = date.slice( 15 );
        return day + '/' + month + '/' + year;   
    }
    console.log( text.replace( regexDate, function( match ) {
        return replaceDate( match );
    }));
