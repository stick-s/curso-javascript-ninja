(function main(window, document) {
    ...
    */
    var username = prompt('Por favor, informe-nos o seu nome');
    if (!username) {
    ...
    */
    var email = prompt('Informe-nos o seu email?');
    ...
    */
    $button.addEventListener('click', function (event) {
        if ($message.value && $inputUsername.value && isValidEmail($inputEmail.value)) {
    ...
    */
    function isValidEmail(email) {
        return /^[.+\w]+@\w+\.\w{2,}\.?\w{0,2}$/.test(email);
    }
    var emails = [
        "meu.email+categoria@gmail.com",
        "juca_malandro@bol.com.br",
