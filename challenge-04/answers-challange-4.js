...
*/
carro.adicionarPassageiros = function (quantidadePassageiros) {
    var humano = assentosDisponiveis === 1 ? " pessoa" : " pessoas";
    var assentosDisponiveis = carro.assentos - carro.quantidadePessoas;
    if (carro.quantidadePessoas < 5) {
        if (assentosDisponiveis < quantidadePassageiros) {
            return "Só cabe mais " + assentosDisponiveis + humano + "!";
        } else {
...
carro.adicionarPassageiros(4); // Só cabe mais 3 pessoas no carro!
...
carro.adicionarPassageiros(10); // Só cabe mais 4 pessoas no carro!
